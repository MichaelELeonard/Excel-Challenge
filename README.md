...
As this is a preliminary report examining trends that may lead to successful crowdsourcing campaigns, future tables and graphs will need to establish a deeper analysis into variables that can influence successful campaigns. Future table/graphs to consider include:   
